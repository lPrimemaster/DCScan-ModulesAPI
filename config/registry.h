...
#define SV_ARG_DCS_DAQ_ChannelRef 0x3 ///< Refers to argument `DCS::DAQ::ChannelRef` \ingroup args_id
...
#define SV_ARG_DCS_Control_UnitTarget 0x6 ///< Refers to argument `DCS::Control::UnitTarget` \ingroup args_id
