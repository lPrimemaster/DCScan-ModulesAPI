...
#define SV_CALL_DCS_ENC_InspectLastEncoderValues 0x8 ///< A call to `DCS::ENC::InspectLastEncoderValues` \ingroup calls_id
...
#define SV_CALL_DCS_Control_a 0xb ///< A call to `DCS::Control::a` \ingroup calls_id
#define SV_CALL_DCS_Control_IssueGenericCommandResponse 0xc ///< A call to `DCS::Control::IssueGenericCommandResponse` \ingroup calls_id
#define MAX_CALL 0xd
...
#define SV_RET_DCS_ENC_EncoderData 0x1 ///< Refers to return type `DCS::ENC::EncoderData` \ingroup ret_id
...
#define SV_RET_DCS_u16 0x4 ///< Refers to return type `DCS::u16` \ingroup ret_id
...
namespace DCS {
	...
	private:
		...
		inline static std::unordered_map<const char*, u16> id = 
		{
			...
			{"DCS::ENC::InspectLastEncoderValues", 0x8},
			{"DCS::Threading::GetMaxHardwareConcurrency", 0x9},
			{"DCS::Control::IssueGenericCommand", 0xa},
			{"DCS::Control::a", 0xb},
			{"DCS::Control::IssueGenericCommandResponse", 0xc}
		};
		...
		inline static std::unordered_map<u16, const char*> r_id_debug = 
		{
			...
			{0x8, "SV_CALL_DCS_ENC_InspectLastEncoderValues"},
			{0x9, "SV_CALL_DCS_Threading_GetMaxHardwareConcurrency"},
			{0xa, "SV_CALL_DCS_Control_IssueGenericCommand"},
			{0xb, "SV_CALL_DCS_Control_a"},
			{0xc, "SV_CALL_DCS_Control_IssueGenericCommandResponse"}
		};
